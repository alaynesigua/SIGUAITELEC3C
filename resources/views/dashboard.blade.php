                ...
                <div ><table style="margin: auto; width:100%" class="min-w-full divide-y divide-gray-200"  >
                    <thead>
                        <tr>
                            ...
                            <th style="background: black;  color:white;" class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Name</th>
                            <th  style="background: black;  color:white;"class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Email</th>
